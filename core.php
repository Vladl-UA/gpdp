 ...
 * «не переизобретать»). Возврат: 'system' | 'dict' | 'main' | 'dependent'.
 *
 ...
 * никогда, в теле такой ветки нет. Заготовка «на будущее» в документе
 * — тот же анти-паттерн §12, что и в коде, только опаснее: код можно
 * проверить исполнением, а обещание в докблоке читают на веру. Когда
 * отчёты появятся, критерий распознавания всё равно придётся писать
 * с нуля.
 */
